...
#define STR_FILES_ENTRY "       %7d %s"
#define STR_FILES_TOTAL_BYTES "Total: %7d bytes"
#define STR_FILES_USED_BYTES "Used : %7d bytes"
#define STR_FILES_FREE_BYTES "Free : %7d bytes"
